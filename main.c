...
int main (int argc, char *argv[]){
    ...
    if(entradaQry != NULL){
        ...
        //Lendo arquivo .qry
        fprintf(svg2, "<svg>\n");
        Ler_arquivo_gry(qry, svg2, txt, arvoreForma, arvoreTexto, arvoreQuadra, arvoreHidrante, arvoreSemaforo, arvoreRadioBase, arvorePosto, arvoreCasos, pessoas, moradores, comercios, diretorioSaida, entradaGeoNew, entradaQryNew);
        fprintf(svg2, "\n</svg>");  
    }
